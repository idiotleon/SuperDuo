...
public class ScoresProvider extends ContentProvider {
    ...
    private static final String SCORES_BY_LEAGUE = ScoresContract.ScoresTable.LEAGUE_COL + " = ?";
    private static final String SCORES_BY_DATE = ScoresContract.ScoresTable.DATE_COL + " LIKE ?";
    private static final String SCORES_BY_ID = ScoresContract.ScoresTable.MATCH_ID + " = ?";
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        //db.delete(ScoresContract.TABLE_NAME,null,null);
        //Log.v(FetchScoreTask.LOG_TAG,String.valueOf(uriMatcher.match(uri)));
            ...
            case MATCHES:
                ...
                try {
                    for (ContentValues value : values) {
                        long _id = db.insertWithOnConflict(ScoresContract.TABLE_NAME, null, value,
